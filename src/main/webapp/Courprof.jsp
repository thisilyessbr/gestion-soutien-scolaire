    ...
    if (session.getAttribute("user") != null) {
        ...
        if (searchByName != null && !searchByName.isEmpty()) {
            try {
                ...
                courList = courDAO.searchCoursbyprofid(searchByName,prof_id);
            } catch (SQLException e) {
                throw new RuntimeException(e);
            }
        } else {
            try {
                courList = courDAO.getCoursbyEnseignantsid(prof_id);
            } catch (SQLException e) {
                throw new RuntimeException(e);
            }
        }
...
<div class="content" id="mainContent">
    ...
    <div>
        <form action="Courprof.jsp" method="get">
                ...
                <div class="modal-body">
                    <form id="CoursForm" method="post" action="addCours">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" class="form-control" value=" <%= user.getMat() %>" name="enseignantMAT" id="enseignantMAT" placeholder="Entrez le MAT de l'enseignant" hidden="hidden">
                            </div>
