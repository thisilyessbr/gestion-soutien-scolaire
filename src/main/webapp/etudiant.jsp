...
<%
    ...
    if (ses.getAttribute("user") != null) {
        ...
        String seancesSql = "SELECT * FROM StudentSeance " +
                "WHERE student_id = ?";
...
<div class="content">
    <div class="page-title">
        <h1>Announcements for Student</h1>
    </div>

    <div class="announcements-container">
        <% while (seancesResultSet.next()) {
            int seanceId = seancesResultSet.getInt("seance_schedule_id");
